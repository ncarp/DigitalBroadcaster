...
HRESULT CWaveFile::ReadMMIO()
{
    ...
    else
    {
		...
		if( (cbExtraBytes==0) && (pcmWaveFormat.wf.wFormatTag==WAVE_FORMAT_MPEG) )
			cbExtraBytes=sizeof(MPEG1WAVEFORMAT)-sizeof(WAVEFORMATEX);
...
DWORD CWaveFile::GetFormatSize()
{
	return m_pwfx->cbSize+sizeof(WAVEFORMATEX);
}
